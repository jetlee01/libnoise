 ...
 * {@link #getValue} method. 0.0 represents the start position of the line
 * segment and 1.0 represents the end position of the line segment.
 * 
 */
public class Line {
	 ...
	 * 0.0) as the ends of the line segment are approached. Default value is
	 * true.
	 */
	private boolean attenuate = true;

	/** A noise module used to generate the output values. */
	private Module module = null;

	/**
	 * The (x,y,z) coordinate of the start of the line segment. Default value is
	 * 0.
	 */
	private float x0 = 0, y0 = 0, z0 = 0;

	/**
	 * The (x,y,z) coordinate of the end of the line segment. Default value is
	 * 1.
	 */
	private float x1 = 1, y1 = 1, z1 = 1;
	 ...
	 * <p>
	 * <strong>pre: </strong>A noise module was passed to the {@link #setModule}
	 * method.<br>
	 * <strong>pre: </strong>The start and end points of the line segment were
	 * specified.
	 * <p>
	 * The output value is generated by the noise module passed to the
	 * {@link #setModule} method. This value may be attenuated (moved toward
	 * 0.0) as <em>p</em> approaches either end of the line segment; this is the
	 * default behavior.
	 * <p>
	 * If the value is not to be attenuated, <em>p</em> can safely range outside
	 * the 0.0 to 1.0 range; the output value will be extrapolated along the
	 * line that this segment is part of.
	 * 
	 * @param p
	 *            The distance along the line segment (ranges from 0.0 to 1.0)
	...
	public float getValue(float p) {
		...
		float y = (y1 - y0) * p + y0;
		float z = (z1 - z0) * p + z0;
		float value = module.getValue(x, y, z);
	 ...
	 * 
	 * @param att
	 *            A flag that specifies whether the output value is to be
	 *            attenuated.
	 */
	...
	/**
	 * Sets the position (x, y, z ) of the end of the line segment to choose
	 * values along.
	 * 
	 * @param x
	...
	/**
	 * Sets the position (x, y, z ) of the start of the line segment to choose
	 * values along.
	 * 
	 * @param x
